...
public class RoutingService {
    ...
    private RoutingService() {
        hopper = createGraphHopperInstance("osm file/egypt-latest.osm.pbf");
    }
    ...
    private GraphHopper createGraphHopperInstance(String ghLoc) {
        ...
        graHopper.setGraphHopperLocation("Osm data/routing-graph-cache");
    ...
    public List<RoutingData> routing(double fromLat, double fromLon, double toLat, double toLon) {
        ...
        for (Instruction instruction : il) {
            this.distance+=instruction.getDistance();
