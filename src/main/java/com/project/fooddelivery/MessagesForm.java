...
public class MessagesForm extends javax.swing.JFrame implements ActionListener {
...
//******** State of Action Button in Dishes ,Cart,Chackout And Order history ***********//
    public MessagesForm(Cart c) {
        
        initComponents();
        setIconImage(new ImageIcon("icons\\icon.png").getImage());
        ArrayList<Message> Messages =  c.getMessageArray();
        JMenu menu; 
        ...
        this.setTitle("Complaints  (" + Messages.size() +" Items )");
...
//******** to make object from dishes pannel ***********//
            ...
            {  
                 ...
                 JPanel sp2 = new MessagesPanel(this,c,Messages.get(i));
                 p2.add(sp2);
     
            }
            
            JPanel sp3 = new NewMessagePanel(this,c);
            p2.add(sp3);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == My_Cart){
            MessagesForm cf = new MessagesForm(FoodDelivery.user.getCart());
            cf.setVisible(true);
